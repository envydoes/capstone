...
$PHPMAILER_LANG['buggy_php']            = 'Din version af PHP er ber�rt af en fejl, som g�r at dine beskeder muligvis vises forkert. For at rette dette kan du skifte til SMTP, sl� mail.add_x_header headeren i din php.ini fil fra, skifte til MacOS eller Linux eller opgradere din version af PHP til 7.0.17+ eller 7.1.3+.';
...
$PHPMAILER_LANG['file_access']          = 'Kunne ikke tilg� filen: ';
...
$PHPMAILER_LANG['invalid_header']       = 'Ugyldig header navn eller v�rdi';
$PHPMAILER_LANG['invalid_hostentry']    = 'Ugyldig hostentry: ';
$PHPMAILER_LANG['invalid_host']         = 'Ugyldig v�rt: ';
...
$PHPMAILER_LANG['recipients_failed']    = 'SMTP fejl: F�lgende modtagere fejlede: ';
...
$PHPMAILER_LANG['no_smtputf8']          = 'Serveren underst�tter ikke SMTPUTF8 som p�kr�vet for at sende til Unicode adresser';
