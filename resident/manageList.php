...
// â”€â”€â”€ Fetch listings for this user from tbl_busaptlisting â”€â”€â”€
$apartmentListings = [];
$businessListings  = [];
...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .form-header { background: linear-gradient(135deg, var(--site-primary-dark) 0%, var(--site-primary) 100%); padding: 20px 28px; text-align: center; }
    ...
    .mtip { background: var(--site-primary-pale); border: 1px solid var(--site-primary-light); border-radius: 8px; padding: 9px 13px; font-size: 0.78rem; color: var(--site-primary-darker); margin-top: 8px; display: flex; align-items: center; gap: 7px; }

    .cc { font-size: 0.7rem; color: #9ca3af; text-align: right; margin-top: 3px; }
    .cc.warn { color: #f59e0b; } .cc.over { color: #ef4444; }

    .submit-btn { display: inline-flex; align-items: center; gap: 8px; padding: 13px 30px; background: linear-gradient(135deg, var(--site-primary-dark) 0%, var(--site-primary) 100%); color: #fff; border: none; border-radius: 10px; font-size: 0.9rem; font-weight: 700; cursor: pointer; font-family: 'DM Sans', sans-serif; transition: all 0.2s ease; box-shadow: 0 4px 14px rgba(var(--site-primary-rgb),0.3); }
    .submit-btn:hover { background: linear-gradient(135deg, var(--site-primary-darker) 0%, var(--site-primary-dark) 100%); transform: translateY(-2px); box-shadow: 0 6px 20px rgba(var(--site-primary-rgb),0.4); }
    ...
    .toast-item.toast-success { background: var(--site-primary-pale); border-color: var(--site-primary-light); color: var(--site-primary-dark); }
    ...
    /* Modal styles */
    .modal-overlay { position: fixed; inset: 0; z-index: 800; background: color-mix(in srgb, var(--site-primary-darker) 50%, transparent); backdrop-filter: blur(4px); display: flex; align-items: flex-start; justify-content: center; padding: 16px; overflow-y: auto; opacity: 0; pointer-events: none; transition: opacity 0.22s; }
    ...
    .sc-icon { width: 26px; height: 26px; background: color-mix(in srgb, var(--site-primary) 20%, white); border-radius: 7px; display: flex; align-items: center; justify-content: center; flex-shrink: 0; }
    ...
    /* Tags in view modal */
    .tag { display: inline-flex; align-items: center; gap: 4px; padding: 3px 10px; border-radius: 999px; font-size: 0.72rem; font-weight: 600; background: var(--site-primary-pale); color: var(--site-primary-dark); border: 1px solid var(--site-primary-light); margin: 2px; }
    ...
    /* Confirm Dialog */
    .dialog-overlay { position: fixed; inset: 0; z-index: 900; background: color-mix(in srgb, var(--site-primary-darker) 50%, transparent); backdrop-filter: blur(4px); display: flex; align-items: center; justify-content: center; padding: 20px; opacity: 0; pointer-events: none; transition: opacity 0.2s; }
    ...
    .badge-avail { background: var(--site-primary-pale); color: var(--site-primary-dark); border: 1px solid var(--site-primary-light); }
...
<!-- â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ MOBILE SIDEBAR â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ -->
...
<main class="max-w-3xl mx-auto px-4 py-10 space-y-10">
  ...
  <div class="f1">
    <a href="residentPanel.php" class="inline-flex items-center gap-2 text-gray-500 hover:text-green-700 text-sm font-medium transition">
  ...
  <section class="f2">
    ...
    <div class="form-card f3">
      ...
      <div class="form-body">
        <!-- ==== KEY FIX: enctype must be multipart/form-data for file uploads ==== -->
        <form method="POST" action="save_listing.php" enctype="multipart/form-data" id="listingForm" novalidate>
          ...
          <div class="dyn-panel" id="panel-apt">
            ...
            <div class="g2 fg">
              <div><label class="fl"><span class="req">*</span>Monthly Rent:</label><div class="price-wrap"><span class="price-pfx">â‚±</span><input type="text" name="apt_price" class="price-in" placeholder="e.g. 3,500"></div></div>
          ...
          <div class="dyn-panel" id="panel-biz">
            ...
            <div class="g2 fg">
              <div><label class="fl">Starting Price / Rate: <span class="hint">(optional)</span></label><div class="price-wrap"><span class="price-pfx">â‚±</span><input type="text" name="buss_price" class="price-in" placeholder="e.g. 30 per load"></div></div>
...
<!-- â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ VIEW MODAL â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ -->
  ...
  <div class="modal" id="viewModal" style="max-width:640px;">
    <div class="modal-header">
      <div class="flex items-center gap-3 min-w-0 flex-1">
        <div style="width:36px;height:36px;background:color-mix(in srgb, var(--site-primary) 20%, white);border-radius:10px;display:flex;align-items:center;justify-content:center;flex-shrink:0;">
...
<!-- â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ EDIT MODAL â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ -->
...
<!-- â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ CONFIRM DIALOG â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ -->
...
/* â”€â”€â”€ Active listings tab â”€â”€â”€ */
...
/* ====
   PHOTOS (create form)
   Uses a JS `files[]` array as a staging
   area, then injects hidden file inputs so
   the real File objects travel with the form.
==== */
let files = [];
const MAX_PHOTOS = 4;
...
function addPh(input) {
  ...
  renderGrid();
  input.value = ''; // reset so the same file can be re-selected if removed
}
...
function validateForm() {
  ...
  // Sync JS file list into the real input before submit
  if (ok && files.length) {
    try {
      const dt = new DataTransfer();
      files.forEach(f => dt.items.add(f));
  ...
  if (isApt) {
    ...
    <div class="section-card">
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        ${vrow('Monthly Rent', l.aptPrice ? 'â‚± ' + Number(l.aptPrice).toLocaleString() : '')}
  ...
  /* â”€â”€â”€ BUSINESS VIEW â”€â”€â”€ */
    ...
    <div class="section-card">
      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        ${vrow('Starting Price', l.bussPrice ? 'â‚± ' + l.bussPrice : '')}
...
/* â”€â”€â”€ EDIT MODAL HELPERS â”€â”€â”€ */
...
/* â”€â”€â”€ APARTMENT EDIT FIELDS â”€â”€â”€ */
function buildAptEditFields(l) {
  ...
  <div class="section-card">
    ...
    <div class="grid grid-cols-2 gap-3">
      ...
      <div>
        <label class="field-label">Monthly Rent (â‚±)</label>
  ...
  <div class="section-card">
    <div class="sc-title"><div class="sc-icon"><i class="fa-solid fa-lightbulb text-green-700 text-xs"></i></div>Included in Rent</div>
    <div class="pg">
      ${buildCheckPills('edit_apt_inc', inc, INC_LABELS, {electric:'fa-bolt',water:'fa-faucet',wifi:'fa-wifi',cable:'fa-tv'})}
    </div>
  </div>
  ...
  <div class="section-card">
    <div class="sc-title"><div class="sc-icon"><i class="fa-solid fa-house text-green-700 text-xs"></i></div>Amenities</div>
    <div class="pg">
      ${buildCheckPills('edit_apt_amn', amn, AMN_LABELS, {aircon:'fa-snowflake',fan:'fa-fan',parking:'fa-car',laundry:'fa-shirt',cctv:'fa-camera',security:'fa-shield-halved',kitchen:'fa-kitchen-set',gate:'fa-lock'})}
    </div>
  </div>
  ...
  <div class="section-card">
    <div class="sc-title"><div class="sc-icon"><i class="fa-solid fa-scroll text-green-700 text-xs"></i></div>House Rules</div>
    <div class="pg">
      ${buildCheckPills('edit_apt_rules', rules, RULES_LABELS, {'no-smoking':'fa-ban-smoking','no-pets':'fa-paw','no-visitors':'fa-user-slash',curfew:'fa-moon','no-cooking':'fa-fire-burner'})}
    </div>
  </div>
...
/* â”€â”€â”€ BUSINESS EDIT FIELDS â”€â”€â”€ */
function buildBizEditFields(l) {
  ...
  <div class="section-card">
    ...
    <div class="grid grid-cols-2 gap-3">
      ...
      <div>
        <label class="field-label">Starting Price / Rate (â‚±)</label>
  ...
  <div class="section-card">
    ...
    <div class="pg">
      ${buildCheckPills('edit_buss_days', days, DAYS_LABELS)}
    </div>
  </div>
  ...
  <div class="section-card">
    <div class="sc-title"><div class="sc-icon"><i class="fa-solid fa-sparkles text-green-700 text-xs"></i></div>Business Features</div>
    <div class="pg">
      ${buildCheckPills('edit_biz_feat', feat, FEAT_LABELS, {delivery:'fa-motorcycle',pickup:'fa-bag-shopping','dine-in':'fa-chair',parking:'fa-car',gcash:'fa-mobile-screen',maya:'fa-mobile-screen',wifi:'fa-wifi',aircon:'fa-snowflake'})}
    </div>
  </div>
...
/* â”€â”€â”€ SHARED EDIT FIELDS â”€â”€â”€ */
...
/* â”€â”€â”€ Photo management in edit modal â”€â”€â”€ */
...
/* â”€â”€â”€ OPEN / CLOSE EDIT MODAL â”€â”€â”€ */
