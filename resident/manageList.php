...
<main class="max-w-3xl mx-auto px-4 py-10 space-y-10">
  ...
  <section class="f2">
    ...
    <div class="form-card f3">
      ...
      <div class="form-body">
        <!-- â”€â”€ KEY FIX: enctype must be multipart/form-data for file uploads â”€â”€ -->
        <form method="POST" action="save_listing.php" enctype="multipart/form-data" id="listingForm" novalidate>
          ...
          <div id="shared-sec" style="display:none;">
            ...
            <div class="fg">
              ...
              <!-- â”€â”€ KEY FIX: name must be photos[] for $_FILES['photos'] to work â”€â”€ -->
...
function openViewModal(row) {
  ...
  /* â”€â”€â”€ SHARED: Contact & Address â”€â”€â”€ */
  ...
  <div class="section-card">
    ...
    <div class="grid grid-cols-2 gap-3">
      ...
      <div>
        ...
        ${buildSelect('edit_bussYears', [['','-- Select --'],['new','Just opened'],['1','1 year'],['2-5','2â€“5 years'],['5-10','5â€“10 years'],['10+','10+ years']], l.bussYears || '')}
      </div>
    </div>
  </div>
