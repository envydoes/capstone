...
<?php endif; ?>
  <header class="w-full h-[68px] border-b border-green-100 flex items-center px-8 bg-white shadow-sm sticky top-0 z-50">
    ...
    <nav class="ml-auto flex items-center gap-4 md:gap-8 text-gray-600 text-sm font-medium">
        ...
        <?php else: ?>
          ...
          <div class="relative" id="profile-menu-wrapper">
            ...
            <div id="profile-dropdown"
              ...
              <!-- Menu items -->
              <div class="py-1">
                <a href="myProfile.php" role="menuitem"
      ...
      <!-- Mobile Menu Button -->
      <button id="mobile-menu-btn" class="md:hidden flex items-center justify-center p-2 text-gray-600 hover:text-[var(--site-primary-dark)] hover:bg-[var(--site-primary-pale)] rounded-lg transition" aria-label="Toggle menu">
  ...
  <div id="mobile-sidebar" class="fixed inset-y-0 right-0 w-72 max-w-[85vw] bg-white shadow-2xl transform translate-x-full transition-transform duration-300 z-[70] flex flex-col">
    ...
    <div class="flex-1 overflow-y-auto py-3 px-3 space-y-0.5">
      ...
      <a href="#announcements" class="flex items-center gap-3 px-4 py-3 rounded-xl text-[var(--site-primary-dark)] font-bold bg-[var(--site-primary-pale)] transition">
...
<section class="max-w-6xl mx-auto px-4 py-16">
  <div class="text-center mb-10">
    <p class="section-label">Resident Services</p>
    <h2 class="text-3xl font-bold text-green-950 mt-2">Available Services</h2>
    <p class="text-gray-500 mt-2 text-sm max-w-xl mx-auto">
      Convenient services available to all barangay residents.
    </p>
  </div>

  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">

    <a href="beneficiaryForm.php" class="service-card rounded-2xl p-7 shadow-sm block text-center group" data-aos="fade-up" data-aos-delay="100">
    ...
    <a href="documentsForm.php" class="service-card rounded-2xl p-7 shadow-sm block text-center group" data-aos="fade-up" data-aos-delay="200">
    ...
    <a href="borrowEquipment.php" class="service-card rounded-2xl p-7 shadow-sm block text-center group" data-aos="fade-up" data-aos-delay="300">
    ...
    <a href="residentLanding.php#announcements" class="service-card rounded-2xl p-7 shadow-sm block text-center group" data-aos="fade-up" data-aos-delay="500">
    ...
    <a href="residentLanding.php#announcements" class="service-card rounded-2xl p-7 shadow-sm block text-center group" data-aos="fade-up" data-aos-delay="600">
