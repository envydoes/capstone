...
if ($isApt) {
    ...
    // Verified: 'sssdsiisisssssssssis' length=20 ✓
    ...
    $stmt->bind_param(
        'sssdsiisisssssssssis',   // ← 20 chars, verified ✓
        $aptTitle,        //  1 s
        $aptType,         //  2 s
        $aptStatus,       //  3 s
        $aptPrice,        //  4 d
    ...
    // Type string (17 chars): 15×s + i + s
    // Verified: 'sssssssssssssssis' length=17 ✓
    ...
    $stmt->bind_param(
        'sssssssssssssssis',   // ← 17 chars, verified ✓
        $bussName,      //  1 s
        $bussCat,       //  2 s
        $bussStatus,    //  3 s
        $bussPrice,     //  4 s
