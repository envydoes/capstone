...
<div class="min-h-screen py-10 px-4">
  ...
  <div class="max-w-4xl mx-auto fade-up fade-up-3">
    ...
    <form id="residentForm" action="residentProfile.php" method="POST" novalidate autocomplete="on">
      ...
      <!-- TERMS (floating modal instead of an inline scroll box) -->
      <div class="terms-summary-row <?php echo isset($errors['terms']) ? 'border-red-400' : ''; ?>" id="termsSummaryRow">
        <div class="terms-summary-text">
          <i class="fa-solid fa-file-shield" style="color:#15803d;"></i>
          <span id="termsStatusText"><?php echo oldValue('terms') === 'agree' ? 'You agreed to the Terms of Service.' : 'Please review and agree to the Terms of Service to continue.'; ?></span>
        </div>
