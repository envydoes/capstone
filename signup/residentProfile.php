...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $data = [
        ...
        'birthplace'         => toProperCase(sanitizeText($_POST['birthplace'] ?? '', 200)),
        ...
        'ethnicity'          => toProperCase(sanitizeText($_POST['ethnicity'] ?? '', 100)),
        'street'             => toProperCase(sanitizeText($_POST['street']    ?? '', 200)),
        ...
        'emergency_contact'  => toProperCase(sanitizeText($_POST['emergency_contact'] ?? '', 150)),
...
/* ============================================================
   ...
   ============================================================ */
['firstname', 'lastname', 'middlename', 'job_title', 'birthplace', 'ethnicity', 'street', 'emergency_contact'].forEach(name => {
