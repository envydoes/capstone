...
$isAdminAccess = $role === 'admin' || $role === 'custom_admin' || !empty($_SESSION['staff_permissions']);
if (!$isAdminAccess) {
    switch ($role) {
        case 'resident':
...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .menu-item:hover  { background: rgba(255,255,255,0.07); color: #d1fae5; }
  ...
  <aside class="sidebar" id="sidebar">
    <div class="sidebar-inner">
      ...
      <nav class="space-y-0.5 px-2">
        <button type="button" onclick="window.location.href='adminDashboard.php'" class="menu-item active">
          <div class="menu-left"><i class="fa-solid fa-chart-bar mi"></i>Dashboard</div>
          <span class="active-dot"></span>
        </button>
        <button type="button" onclick="window.location.href='userManagement.php'" class="menu-item">
          <div class="menu-left"><i class="fa-solid fa-user mi"></i>User Management</div>
        </button>
        <button type="button" onclick="window.location.href='residentManagement.php'" class="menu-item">
          <div class="menu-left"><i class="fa-solid fa-house-chimney-user mi"></i>Resident Management</div>
        </button>
        <button type="button" onclick="window.location.href='beneficiaryManagement.php'" class="menu-item">
          <div class="menu-left"><i class="fa-solid fa-hand-holding-heart mi"></i>Beneficiary Management</div>
        </button>
        <button type="button" onclick="window.location.href='documentRequest.php'" class="menu-item">
          <div class="menu-left"><i class="fa-regular fa-file-lines mi"></i>Document Request</div>
        </button>
        <button type="button" onclick="window.location.href='borrowingSystem.php'" class="menu-item">
          <div class="menu-left"><i class="fa-solid fa-hammer mi"></i>Borrowing System</div>
        </button>
      </nav>
      ...
      <nav class="space-y-0.5 px-2">
        <button type="button" onclick="window.location.href='communityListings.php'" class="menu-item"><div class="menu-left"><i class="fa-solid fa-building mi"></i>Community Listings</div></button>
        <button type="button" onclick="window.location.href='announcement.php'" class="menu-item"><div class="menu-left"><i class="fa-solid fa-pen-to-square mi"></i>Announcements</div></button>
      </nav>
    ...
    <div class="p-5 flex-1 space-y-5">
      ...
      <div class="panel f3">
        ...
        <div class="report-pane hidden" id="pane-equipment">
          ...
          <div class="subpanel">
            <p class="subpanel-title">Currently Borrowed / Overdue Items <span class="subpanel-note">(live database search)</span></p>
            <div class="mini-filter-row">
              <div class="mini-search-wrap" style="flex:1;min-width:200px;">
...
<script>
  ...
  function drawIncomeVsAgeChart() {
    ...
    new google.visualization.ColumnChart(document.getElementById('incomeVsAgeChart')).draw(data, options);
}
  ...
  function drawBar() {
    ...
    new google.charts.Bar(document.getElementById('barchart')).draw(
      data,
      google.charts.Bar.convertOptions({
        chart: { title: '' },
        bars: 'vertical',
        colors: ['#3b82f6', '#10b981', '#f59e0b'],
        legend: { position: 'none', textStyle: { color: '#6b7280', fontSize: 12 } },
        backgroundColor: 'transparent',
        bar: { groupWidth: '65%' },
        vAxis: {
  ...
  function drawDonut() {
    ...
    new google.visualization.PieChart(document.getElementById('donutchart')).draw(data, {
      pieHole: 0.6,
  ...
  document.getElementById('gfOverlay')?.addEventListener('click', (e) => {
  ...
  function drawReportTab(tab) {
    ...
    if (tab === 'beneficiary') { drawBenProgramsChart(); nonBenTable.render(); }
  ...
  function drawPurokChart() {
    ...
    new google.visualization.ColumnChart(document.getElementById('chartPurok')).draw(data, {
  ...
  function drawAgeBracketChart() {
    ...
    new google.visualization.PieChart(document.getElementById('chartAgeBracket')).draw(data, {
  ...
  function drawBenProgramsChart() {
    ...
    new google.visualization.ColumnChart(document.getElementById('chartBenPrograms')).draw(data, {
      backgroundColor: 'transparent', legend: { position: 'none' }, colors: ['#15803d'],
  ...
  function drawListingTypeChart() {
    ...
    new google.visualization.PieChart(document.getElementById('chartListingType')).draw(data, {
  ...
  function drawOccupancyChart() {
    ...
    new google.visualization.PieChart(document.getElementById('chartOccupancy')).draw(data, {
  ...
  function drawMostBorrowedChart() {
    ...
    new google.visualization.BarChart(document.getElementById('chartMostBorrowed')).draw(data, {
  ...
  function drawDocMonthlyChart() {
    ...
    new google.visualization.LineChart(document.getElementById('chartDocMonthly')).draw(data, {
  ...
  function drawRoleCountsChart() {
    ...
    new google.visualization.PieChart(document.getElementById('chartRoleCounts')).draw(data, {
  ...
  function drawAccountStatusChart() {
    ...
    new google.visualization.PieChart(document.getElementById('chartAccountStatus')).draw(data, {
  ...
  function drawRegTrendChart() {
    ...
    new google.visualization.LineChart(document.getElementById('chartRegTrend')).draw(data, {
      backgroundColor: 'transparent', legend: { position: 'none' }, colors: ['#15803d'],
      chartArea: { left: 46, right: 20, top: 20, bottom: 40, width: '90%', height: '75%' },
      hAxis: { textStyle: { color: '#6b7280', fontSize: 10 } },
      vAxis: { minValue: 0, textStyle: { color: '#6b7280' }, gridlines: { color: '#f3f4f6' } },
...
<div class="gf-overlay" id="gfOverlay">
  <div class="gf-modal">
    ...
    <div class="gf-modal-body">
      ...
      <div class="gf-section">
        <p class="gf-section-title">Housing &amp; Utilities</p>
        <div class="gf-grid">
          <div class="gf-field">
            <label>Housing Status</label>
            <select id="gfHousingStatus">
              <option value="">Any</option>
      ...
      <div class="gf-section">
        ...
        <div class="gf-grid">
          <div class="gf-field"><label>Pregnant / Children &lt;5</label><select id="gfPregnantChildren"><option value="">Any</option><option value="1">Yes</option><option value="0">No</option></select></div>
          <div class="gf-field"><label>Is PWD</label><select id="gfIsPwd"><option value="">Any</option><option value="1">Yes</option><option value="0">No</option></select></div>
          <div class="gf-field"><label>Is Solo Parent</label><select id="gfIsSoloParent"><option value="">Any</option><option value="1">Yes</option><option value="0">No</option></select></div>
      ...
      <div class="gf-section">
        <p class="gf-section-title">Education</p>
        <div class="gf-grid">
          <div class="gf-field"><label>School</label><input type="text" id="gfSchool" placeholder="School name"></div>
          <div class="gf-field"><label>Course</label><input type="text" id="gfCourse" placeholder="Course / program"></div>
          <div class="gf-field">
            <label>Year Level</label>
            <select id="gfYearLevel">
              <option value="">Any</option>
          ...
          <div class="gf-field"><label>GWA / GPA</label><input type="text" id="gfGwa" placeholder="e.g. 1.75"></div>
        </div>
      </div>
