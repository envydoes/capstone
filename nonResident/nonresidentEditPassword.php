<?php
// non-resident settings page
// This page displays non-resident profile settings and allows password changes
...
if (!in_array('non-resident', $roleParts, true)) {
...
<head>
    ...
    <style>
        ...
        /* Tailwind-green ?T theme color overrides */
        ...
        /* Tailwind-emerald ?T theme color overrides (role cards / focus rings) */
    ...
    <main class="mx-auto max-w-6xl px-4 py-8 md:px-6 md:py-10 space-y-8">
      <section class="rounded-2xl border border-green-100 bg-white p-6 md:p-8 shadow-sm">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h1 class="text-3xl md:text-4xl font-bold text-slate-900">Non-Resident Settings</h1>
...
<div class="w-full mx-auto px-4 md:px-0">
  <div class="lg:col-span-3">
    ...
    <div class="rounded-2xl flex gap-3 mb-6 -mx-4 md:mx-0 px-4 md:px-8 bg-white py-4">
      <a href="nonresidentEditProfile.php" class="flex-1 text-center px-5 py-2 bg-white text-slate-700 font-semibold rounded-lg border border-slate-200 inline-flex items-center justify-center gap-2 hover:bg-slate-50 transition">
        <i class="fas fa-user-circle"></i>
        Profile
      </a>
      <a href="nonresidentEditPassword.php" class="flex-1 text-center px-5 py-2 bg-emerald-600 text-white font-semibold rounded-lg inline-flex items-center justify-center gap-2 shadow-sm hover:bg-emerald-700 transition">
