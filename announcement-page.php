      ...
      <?php else: ?>
        <div class="relative" id="profile-menu-wrapper">
          ...
          <div id="profile-dropdown" class="hidden absolute right-0 mt-2 w-64 bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden z-50" role="menu">
            ...
            <div class="py-1">
              <a href="profile.php" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-green-50 transition"><i class="fa-solid fa-user w-4 text-gray-400"></i> My Profile</a>
              <?php if ($role === 'admin'): ?>
              <a href="settings.php" class="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-700 hover:bg-green-50 transition"><i class="fa-solid fa-gear w-4 text-gray-400"></i> Settings</a>
              <?php endif; ?>
              <?php if ($roleLower === 'admin'): ?>
...
<div id="mobile-sidebar" class="fixed inset-y-0 right-0 w-72 max-w-[85vw] bg-white shadow-2xl transform translate-x-full transition-transform duration-300 z-[70] flex flex-col">
  ...
  <div class="flex-1 overflow-y-auto py-3 px-3 space-y-0.5">
    ...
    <a href="busaptListing.php?type=business" class="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 font-medium hover:bg-green-50 hover:text-green-700 transition">
      <i class="fa-solid fa-store w-4 text-blue-500"></i> Business
    </a>
    ...
    <div class="pt-2 border-t border-gray-100 mt-2 space-y-0.5">
      <a href="profile.php" class="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 font-medium hover:bg-green-50 hover:text-green-700 transition">
        <i class="fa-solid fa-user w-4 text-gray-400"></i> My Profile
      </a>
      <?php if ($role === 'admin'): ?>
      <a href="settings.php" class="flex items-center gap-3 px-4 py-3 rounded-xl text-gray-700 font-medium hover:bg-green-50 hover:text-green-700 transition">
