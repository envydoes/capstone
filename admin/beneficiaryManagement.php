...
function openViewModal(row, type, triggerBtn = null) {
  ...
  let progRows = progDetails.map(p => `
    <div class="detail-row">
      ...
      <span class="detail-val" style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;">
        ${p.met
          ? `<span style="background:#dcfce7;color:#15803d;padding:2px 10px;border-radius:99px;font-size:0.72rem;font-weight:700;border:1px solid #bbf7d0;">�o" Eligible</span>`
          : `<span style="background:#f3f4f6;color:#9ca3af;padding:2px 10px;border-radius:99px;font-size:0.72rem;font-weight:700;">�o- Not Eligible</span>`}
  ...
  const priorityCard = isPending
    ? `<div class="priority-card">
        <div style="width:48px;height:48px;background:rgba(255,255,255,0.15);border-radius:12px;display:flex;align-items:center;justify-content:center;font-size:1.6rem;">�Y�.</div>
        <div style="flex:1;">
